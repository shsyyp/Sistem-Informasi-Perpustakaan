    ...
    <div class="card">
        <div class="d-flex flex-column flex-md-row p-4">
            <div class="d-flex flex-grow-1 head-label text-center">
                <h5 class="card-title mb-0">Tambah Buku Pustaka</h5>
            </div>
        ...
        <div class="card-body pt-0">
            <form action="{{ route('buku.store') }}" class="form" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control @error('th_terbit') is-invalid @enderror" name="th_terbit" value="{{ old('th_terbit') }}">
